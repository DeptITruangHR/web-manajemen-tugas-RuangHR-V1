            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center mb-4">
                        <h1 class="h3 mb-0 text-gray-800" style="font-weight:700">Tugas</h1>
                        <a href="<?php echo base_url().'index.php/managementCtl/tambahTugas'?>" class="d-none ml-auto d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-square"></i> Lapor Tugas</a>
                                    ...
                                    <!-- sementara data nya manual dulu nanti di ambil dari database -->
                                        ...
                                        foreach($mytask as $task){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url().'index.php/managementCtl/detailTugas?kode='.$task['kode'];?>"><button class="btn" style="background:#D5EAF8;color:#0E3854">Detail</button></a></td>
                        ...
                        <?php 
                            ...
                            foreach($myUndoneTask as $task){
                                ...
                                <tr>
                                    <td><?php echo htmlentities($task['pekerjaan']) ?></td>
                                    <td><?php echo htmlentities($task['date']) ?></td>
                                    <td><a href="<?php echo base_url().'index.php/managementCtl/updateTugas?kode='.$task['kode'];?>"><button class="btn" style="background:#D5EAF8;color:#0E3854">Update</button></a></td>
                                </tr>
